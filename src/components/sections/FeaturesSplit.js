            ...
            <div className="split-item">
              ...
              >
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8">
                  Metete al Google Meet
                </div>
                <h3 className="mt-0 mb-12">Presentación del proyecto final</h3>
                <p className="m-0">
                  El lobo va a estar contando qué hizo en el proyecto final, y
                  cuando termine se va a llevar un merecido aplauso, mientras
                  nos vamos preparando para darle duro y parejo más tarde
                </p>
              </div>
              <div
