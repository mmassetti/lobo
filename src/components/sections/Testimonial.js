...
import UnlockedHeader from "./partials/UnlockedHeader";
...
const Testimonial = ({
  ...
  const unlockedHeader = {
    ...
    paragraph: "¡Ahora sí tenemos Ingeniero!",
  };
      ...
      <div className="container">
        <div className={innerClasses}>
          ...
          <>
            ...
            <UnlockedHeader data={unlockedHeader} className="center-content " />
            ...
            <div className={tilesClasses}>
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      todo lo que haces y te propones (menos en el cs)... te
                      digo estas palabras con lágrimas de alegría en los ojos.
                      <br />
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      insanas. Si mis cálculos no fallan, y sin ánimos de mufar,
                      creo que la vida después de este título te va a ser más EZ
                      que matar al Profeta en CS GO. <br /> <br />
                      Felicitaciones brodie y muchos exitos para lo que viene.
                      Espero seguir puteando iniciados hasta la eternidad junto
                      a vos. <br />
                      <span style={{ fontWeight: "bolder", color: "white" }}>
                        Te quiero mucho. JC.
                      </span>
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      objetivo. Espero que tengas muchos éxitos en tus
                      proyectos, ya sabes que si necesitas un web dev me mandas
                      un inbox. <br /> <br /> Te quiero bro. Felicitaciones y ..{" "}
                      <br />{" "}
                      <span style={{ fontWeight: "bolder", color: "white" }}>
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      cecom a un labo a las 10 de la matina, cuando tuviste los
                      huevos de decirle a la michelina en pleno examen que el
                      problema 3 era una cagada, o como cuando le pusimos micho
                      tito en el proyector y lo leyó. Que vieja del orte. <br />
                      <br />
                      <span style={{ fontWeight: "bolder", color: "white" }}>
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      patio del Reino con Santi Bruno, él me mira con un Gancia
                      en una mano, un Melbour en la otra y me dice “nosotros dos
                      vamos a ser los primeros en recibirnos, Bola” (Santi de
                      abogado y yo de licenciado en composición, profe de
                      teatro, contrabajista, locutor nacional o alguna mierda de
                      esas). A mí se me llenaron los ojos de lagrimas y asentí
                      con la cabeza (del pedo que tenía no podía hablar bien).{" "}
                      <br /> <br />
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      muy contento por esto que lograste, te deseo lo mejor para
                      la nueva etapa que empezas , que sos el capitán del team
                      de inicia2. <br /> <br />
                      <span style={{ fontWeight: "bolder", color: "white" }}>
              ...
              >
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      — Querido y entrañable amigo Mati! <br /> <br /> Desde que
                      nos conocimos en el quincho de JV un 25 de Septiembre y a
                      partir de que nos hicimos amigos en esas noches de Teke en
                      Ohiggin's, forjamos una amistad riquísima, a veces con
                      reproches por algún huesito perdido, pero siempre con amor
                      bbcito! <br /> <br /> Mis felicitaciones a este esfuerzo
                      enorme que hiciste, y por las ganas que le pones a todo
                      seguramente lo que venga va a ser mejor. Disfruta de
                      trabajar de lo que te gusta que es lo importante. <br />{" "}
                      <br />{" "}
                      <span style={{ fontWeight: "bolder", color: "white" }}>
              ...
              >
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      — Mati, querido amigo, llegado semejante momento, dificil
                      encontrar las palabras justas. <br /> <br /> El viernes es
                      un momento bisagra, das paso a una nueva etapa con cambios
                      muy importantes para vos. Me alegra mucho haber compartido
                      con vos el antes, el durante de este proceso y sobre todo
                      poder acompañarte en el comienzo de tu etapa INGENIERIL.{" "}
                      <br /> <br /> Sos el primero del Sexteto y sin dudas un
                      orgullo. Sin mas preambulo, GEOMETRIC WOLF, ANGELICAL TANK
                      EATER, y sobre todo INGENIERETE...Lo mejor en lo que
                      viene. <br /> <br />
                      <span style={{ fontWeight: "bolder", color: "white" }}>
                        Te quiero!
                      </span>
              ...
              <div className="tiles-item reveal-from-bottom">
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      — Amigo Felícitaciones !!! <br /> <br /> Vos más que nadie
                      te mereces esto y mucho más. Todo el esfuerzo valió la
                      pena !!! Sabes que te amo con todo mi corazón y a pesar de
                      que a veces colguemos siempre estamos el uno para el
                      otro... y espero que sea así por Muchos años más. Se
                      vienen muchas cosas nuevas y mejores!! <br /> <br />
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      tardes de chipa y fifa, bueno espero que ahora te instales
                      en una casa y abandones las mudanzas, abrazo amigo pd: lo
                      tuyo no es el cs.{" "}
                  ...
                  <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                    ...
                    <span className="text-color-low"> / </span>
                    <span className="testimonial-item-link">Soldano De 8</span>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      — Felicitaciones Arnold Schwarzenegger por este gran logro
                      y te deseo el mejor de los éxitos en esta nueva etapa en
                      busca de los verdolagas. <br /> <br />
                      <span style={{ fontWeight: "bolder", color: "white" }}>
                        {" "}
                      ...
                      <br /> <br />
                      <span style={{ fontWeight: "bolder", color: "#F7F256" }}>
                ...
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      ...
                      Felicitaciones amigo por este logroooo. Sos un crack y te
                      va a ir genial en lo que te propongas. <br /> <br />{" "}
              ...
              <div className="tiles-item reveal-from-bottom">
                <div className="tiles-item-inner">
                  <div className="testimonial-item-content">
                    <p className="text-sm mb-0">
                      — Mati te felicito por este logro tan grande, estoy más
                      que orgullosa de vos! <br /> <br />
                      Gracias por dejarme acompañarte en este camino. Ahora lo
                      mejor está por venir y para eso espero que estén cuentitas
                      las claras. <br /> <br />
                      <span style={{ fontWeight: "bolder", color: "white" }}>
                  ...
                  <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                    ...
                    <span className="text-color-low"> / </span>
                    <span className="testimonial-item-link">la negra</span>
                  </div>
                </div>
              </div>
            </div>
