          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12" style={{ color: "#F7F256" }}>
                  {" "}
                  SE TE SUBIÓ - SHORT VERSIÓN
                </h3>
            ...
            <div className="split-item">
              ...
              >
                ...
                <h3 className="mt-0 mb-12" style={{ color: "#F7F256" }}>
                  PERDONA CLEFFA NO ERA PARA VOS{" "}
                </h3>
                <p className="m-0">Ligó el lobo geométrico</p>
              </div>
              <div
                className={classNames(
                  "split-item-image center-content-mobile reveal-from-bottom",
              ...
              >
                <ReactPlayer
                  ...
                  height={"75px"}
                  width={"350px"}
                  url="https://res.cloudinary.com/sebanoe/video/upload/v1617921801/MatiRios/videos/audios/lobomalo_n4qb8k.mp3"
                />
              </div>
            </div>
            ...
            <div className="split-item">
              ...
              >
                <ReactPlayer
                  ...
                  height={"75px"}
                  width={"350px"}
                  url="https://res.cloudinary.com/sebanoe/video/upload/v1617922806/MatiRios/videos/audios/chaca_t26l1v.mp3"
                />
              </div>
            </div>
          </div>
